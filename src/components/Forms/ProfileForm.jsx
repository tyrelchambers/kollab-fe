    ...
    <div className="flex">
      <form className="w-1/2 mr-4" onSubmit={handleSubmit(submitHandler)}>
        ...
        <InfoBlock>
          ...
          <div className="field-group">
            <label htmlFor="gitlab" className="form-label">
              Gitlab
            </label>
          ...
          <div className="flex mt-8">
            <input
              type="checkbox"
              name="availableToHelp"
              id="availableToHelp"
              className="mr-4"
              checked={profile.availableToHelp}
              onChange={(e) =>
                setProfile({ ...profile, availableToHelp: e.target.checked })
              }
            />

            <label htmlFor="availableToHelp" className="form-label">
              Available to help
            </label>
          </div>

          <MainButton text="Save profile" type="submit" className="mt-4" />
        </InfoBlock>
      </form>
      ...
      <div className="w-1/2">
        ...
        <InfoBlock>
          ...
          <MainButton text="Save passwords" className="mt-4" />
        </InfoBlock>
      </div>
    </div>
  );
